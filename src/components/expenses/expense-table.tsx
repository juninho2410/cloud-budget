    ...
    return (
        <Table>
            ...
            <TableBody>
                {expenses.length === 0 && (
                    <TableRow>
                        <TableCell colSpan={7} className="text-center">No expense entries found.</TableCell>
                    </TableRow>
                )}
                {expenses.map((expense) => ( // Iterate over expenses
                    <TableRow key={expense.id}>
                        ...
                        <TableCell>{expense.business_line_name || <span className="text-muted-foreground">-</span>}</TableCell>
                        <TableCell>{expense.cost_center_name || <span className="text-muted-foreground">-</span>}</TableCell>
